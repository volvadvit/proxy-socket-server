...
public class JsonParserTest extends TestCase {
    ...
    private final String jsonTest = "{\"name\":\"Moscow_test\",\"country\":\"RU\"," +
            "\"weather\":\"light rain\",\"visibility\":10000,\"wind\":2.31}";

    private final CityWeatherBean dummy = new CityWeatherBean("Moscow_test", "RU",
    ...
    public void testParseJson() {
        String jsonTest =
                "{" +
                        ...
                        "\"base\":\"stations\"," +
                        "\"main\":{\"temp\":288.57,\"feels_like\":288.33,\"temp_min\":288.23,\"temp_max\":289.28,\"pressure\":1018,\"humidity\":83,\"sea_level\":1018,\"grnd_level\":1000}," +
                        "\"visibility\":10000," +
                        "\"wind\":{\"speed\":2.31,\"deg\":27,\"gust\":4.21},\"rain\":{\"1h\":0.37}," +
                        "\"clouds\":{\"all\":100}," +
                        "\"dt\":1631288731," +
                        "\"sys\":{\"type\":2,\"id\":2009195,\"country\":\"RU\",\"sunrise\":1631242307,\"sunset\":1631289698}," +
                        "\"timezone\":10800,\"id\":524901,\"name\":\"Moscow_test\",\"cod\":200" +
                        "}";
